    ...
    <>
      <main className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-white">
        ...
        <nav className="border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
          <div className="mx-auto flex h-20  items-center justify-between px-6 lg:px-8 dark:text-white dark:bg-slate-950">
            {/* Logo */}
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/signin"
                className="rounded-lg bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-800 dark:bg-indigo-600 dark:hover:bg-indigo-700"
              >
                Get Started
              </Link>
              <ThemeToggle />
        ...
        <section className="relative overflow-hidden">
          {/* Background glow */}
          <div className="absolute left-1/2 top-0 -z-10 h-[500px] w-[700px] -translate-x-1/2 rounded-full bg-indigo-100/50 blur-3xl dark:bg-indigo-900/20" />

          <div className="mx-auto grid max-w-7xl items-center gap-16 px-6 py-24 lg:grid-cols-2 lg:px-8 lg:py-32">
            {/* Hero Content */}
            <div>
              <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-indigo-50 px-4 py-2 text-sm font-medium text-indigo-600 dark:bg-indigo-950/50 dark:text-indigo-400">
                <span>✦</span>
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/analyze"
                  className="rounded-xl bg-indigo-600 px-6 py-3.5 text-center text-sm font-semibold text-white shadow-lg shadow-[#4F39F6] transition hover:bg-indigo-700"
                >
                  Analyze Your Idea →
                </Link>
              ...
              <div className="mt-10 flex items-center gap-4">
                ...
                <p className="text-sm text-slate-500">
                  <span className="font-semibold text-slate-900 dark:text-indigo-600">500+</span>{" "}
            ...
            <div className="relative">
              {/* Floating card */}
              <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl shadow-slate-200/70 dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/20">
                {/* Header */}
                ...
                <div className="mt-8 flex items-center gap-6">
                  <div className="flex h-28 w-28 flex-col items-center justify-center rounded-full border-[10px] border-indigo-500 bg-indigo-50 dark:bg-indigo-950/40">
                ...
                {/* Recommendation */}
                <div className="mt-7 rounded-xl bg-indigo-50 p-4 dark:bg-indigo-950/40">
        ...
        {/* ================= FEATURES ================= */}
        <section className="bg-white px-6 py-24 dark:bg-slate-900 lg:px-8">
        ...
        <section
          id="how-it-works"
          className="bg-slate-50 px-6 py-24 dark:bg-slate-950 lg:px-8"
        >
          <div className="mx-auto max-w-7xl">
            <SectionHeading
              label="HOW IT WORKS"
        ...
        <section
          id="investors"
          className="bg-white px-6 py-24 dark:bg-slate-900 lg:px-8"
        >
          <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-2">
            <div>
              ...
              <Link
                href="/startups"
                className="mt-8 inline-block rounded-xl dark:bg-[#4F39F6] bg-slate-900 px-6 py-3.5 text-sm font-semibold text-white hover:bg-slate-800"
              >
                Explore Startups →
              </Link>
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 dark:border-slate-800 dark:bg-slate-950">
              <div className="rounded-2xl bg-white p-6 shadow-sm dark:bg-slate-900">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="mt-6 max-w-lg text-lg leading-8 text-slate-600 dark:text-slate-400">FEATURED STARTUP</p>
                  ...
                  <span className="rounded-lg bg-indigo-50 px-3 py-2 text-sm font-bold text-indigo-600 dark:bg-indigo-950/50 dark:text-indigo-400">
                    82/100
                  </span>
                </div>
        ...
        {/* ================= CTA ================= */}
        <section className="bg-white dark:bg-slate-900 dark:text-white px-6 py-28 text-center text-black">
          <h2 className="text-4xl font-bold tracking-tight sm:text-5xl">
            Have an idea?
            <br />
            <span className="text-[#4F39F6]">Let&apos;s validate it.</span>
          </h2>
        ...
        {/* ================= FOOTER ================= */}
        <footer className="bg-white px-6 py-12 dark:bg-slate-900">
          <div className="mx-auto max-w-7xl">
